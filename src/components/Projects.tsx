...
const Projects = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            // Initial setup to ensure proper starting state
            gsap.set([firstCardRef.current, secondCardRef.current], {
                y: 100,
                opacity: 0
            });
    ...
    return (
        <div ref={sectionRef} id='projects' className="min-h-screen bg-gradient-to-r from-amber-50 to-amber-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div ref={headingRef} className="text-center mb-8">
                    <h2 className="text-4xl font-bold text-amber-800 mb-2 font-[Underdog]">Projects</h2>
                    <p className="text-amber-700">Showcasing my latest work and experiments</p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div className="min-w-0">
                                    <h3 className="text-xl font-bold text-amber-800 mb-1">NbkristQik</h3>
                            ...
                            <div className="mb-4">
                                <p className="text-gray-600 text-sm mb-3">
                                    A Telegram bot designed to help students quickly check their attendance and mid-term marks.
                                    Streamlines the process of accessing academic information, making it more convenient for students
                                    to stay updated with their academic progress.
                                </p>
                                <div>
                                    <h4 className="text-xs font-semibold text-amber-700 mb-1">Key Features:</h4>
                            ...
                            <div>
                                <h4 className="text-xs font-semibold text-amber-700 mb-1">Technologies Used:</h4>
                    ...
                    >
                        <div className="p-6">
                            ...
                            <div className="mb-4">
                                <p className="text-gray-600 text-sm mb-3">
                                    A comprehensive web platform that extends the functionality of NbkristQik bot with advanced
                                    features like activity tracking, detailed statistics, and a personalized dashboard for each student.
                                </p>
                                <div>
                                    <h4 className="text-xs font-semibold text-amber-700 mb-1">Key Features:</h4>
                                    <ul className="list-disc list-inside text-gray-600 text-sm space-y-0.5">
