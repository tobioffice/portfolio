...
const ContactMe = () => {
  ...
  return (
    <div
      ref={sectionRef}
      id="contact"
      className="min-h-screen bg-gradient-to-r from-amber-50 to-amber-100 py-16 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-3xl mx-auto">
        <div ref={headingRef} className="text-center mb-12">
          <h2 className="text-4xl font-bold text-amber-800 mb-4 font-[Underdog]">
            Get in Touch
          </h2>
        ...
        >
          <input
            type="hidden"
            name="access_key"
            value="b3f2107e-4d41-41b4-bf5c-503d68ffcf19"
          />
